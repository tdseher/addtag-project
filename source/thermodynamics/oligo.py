...
class Oligo(object): # Name of the subclass
    ...
    def __init__(self, 
        ...
        self.authors = authors       # Authors of the thermodynamics calculator (str)
        self.title = title
    ...
    # TODO: 'Oligo.scan()' isn't used, and has been replaced by 'Primer.scan()'
    ...
    # TODO: Either finish or remove 'Oligo.weighted_scan()'
    ...
    # TODO: Either finish or remove 'Oligo.relaxing_scan()'
